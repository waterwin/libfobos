...
class FeatureDetector(object):
    features = {
        ...
        # edited by PE3ES / F4VTQ / Erwin in 2025
    ...
    def has_soapy_fobos(self):
        """
        The SoapySDR module for Fobos SDR is required for interfacing with it

        You can get it [here](https://github.com/rigexpert).
        """
